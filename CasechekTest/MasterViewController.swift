...
class MasterViewController: UITableViewController, NSFetchedResultsControllerDelegate {
    ...
    var fetchedResultsController: NSFetchedResultsController<Site> {
        ...
        let aFetchedResultsController = NSFetchedResultsController(fetchRequest: fetchRequest, managedObjectContext: DataModel.sharedInstance.persistentContainer.viewContext, sectionNameKeyPath: nil, cacheName: "Master")
